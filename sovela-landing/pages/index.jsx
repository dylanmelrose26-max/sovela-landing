  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        maxWidth: T.spacing.maxWidth, margin: "0 auto",
        padding: `clamp(140px, 18vh, 200px) ${T.spacing.contentX} 0`,
      }}>
        {/* ── Centred text block ── */}
...
function ExecutiveReportMockup({ activeReport = null }) {
  const sage = "#8BAF8B";
  const paleRed = "#C4946A";
  const amber = "#C9A84C";
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 200 }}>
      ...
      <div style={{
        ...
        <div style={{ padding: "32px 40px 0", display: "flex", justifyContent: "flex-end" }}>
          <button onClick={handleClose} style={{ background: "none", border: "none", cursor: "pointer", padding: 8 }}>
        ...
        <div style={{ flex: 1, padding: "40px 48px 48px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          {formState === "success" ? (
        ...
        <div style={{ padding: "24px 48px", borderTop: `1px solid ${T.colors.border}`, display: "flex", alignItems: "center", gap: 8 }}>
    ...
    <footer style={{ background: T.colors.textPrimary, padding: "60px 0 40px" }}>
      <div style={{ maxWidth: T.spacing.maxWidth, margin: "0 auto", padding: `0 ${T.spacing.contentX}` }}>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
          <p style={{ fontFamily: T.fonts.body, fontWeight: 300, fontSize: 11, color: "rgba(255,255,255,0.25)", margin: 0 }}>&copy; 2025 sovela. All rights reserved.</p>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
